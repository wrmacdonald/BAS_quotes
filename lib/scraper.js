...
const scraperObjTruecar = async (car_data, local_run) => {
  ...
  const next = await page.waitForXPath(
    '//*[@id="mainContent"]/div/div/div[3]/div/form/div[2]/div[2]/button'
  );
  await next.click();
  ...
  // or instead select first color
  //*[@class="row"]/div[1]/label/input
  const first_color_btn = await page.waitForXPath(
    `//*[@id="mainContent"]/div/div/div[3]/div/form/div[1]/div/div[1]/fieldset/div/div[1]/label/div/div/div[1]`
  );
  await first_color_btn.click();
